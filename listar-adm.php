        ...
        <tbody class="table-group-divider">
            ...
            while ($dados = $sql->fetch_object()) { ?>
                <tr>
                    ...
                    <td><?= $dados->senha ?></td>
                    <td>
                        <a href="editar-adm.php?id=<?= $dados->id ?>" class="btn btn-outline-secondary"> <i class="fa-solid fa-pen-to-square"></i>Editar</a>
                        <a href="excluir.php?id=<?= $dados->id ?>" class="btn btn-outline-danger"><i class="fa-solid fa-trash">Excluir</i></a>
                    </td>
                </tr>
            <?php }
            ?>
